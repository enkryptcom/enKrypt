...
export const createECashNetworkOptions = (
  ...
  return {
    ...
    blockExplorerAddr:
      ...
      'https://explorer.e.cash/address/ecash:[[address]]',
    ...
    coingeckoID: 'coingeckoID' in options ? options.coingeckoID : 'ecash',
  ...
  constructor(options: ECashNetworkOptions) {
    ...
    const baseOptions: BaseNetworkOptions = {
      ...
      displayAddress: (pubkey: string) =>
        getAddress(pubkey, options.cashAddrPrefix || 'ecash'),
      api,
...
const ecashOptions = createECashNetworkOptions({
  ...
  blockExplorerAddr: 'https://explorer.e.cash/address/ecash:[[address]]',
  isTestNetwork: false,
  currencyName: 'XEC',
