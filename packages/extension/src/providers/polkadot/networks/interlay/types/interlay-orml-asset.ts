...
export interface InterlayOrmlAssetOptions extends BaseTokenOptions {
  assetType: OrmlAssetType;
  lookupValue: string | number;
}

export class InterlayOrmlAsset extends SubstrateToken {
  public assetType: OrmlAssetType;
  public lookupValue: string | number;

  constructor(options: InterlayOrmlAssetOptions) {
    super(options);
