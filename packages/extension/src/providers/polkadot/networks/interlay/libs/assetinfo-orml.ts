...
import {
  InterlayOrmlAsset,
  InterlayOrmlAssetOptions,
  OrmlAssetType,
} from "../types/interlay-orml-asset";
...
export default async (
  ...
  const tokenOptions: InterlayOrmlAssetOptions[] = assets
    .map((asset) => {
      const ormlOptions: InterlayOrmlAssetOptions = {
  ...
  return [nativeAsset, ...tokenOptions.map((o) => new InterlayOrmlAsset(o))];
};
