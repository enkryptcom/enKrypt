...
export async function getSparkState(selectedAccount: SignOptions): Promise<SparkAccount | undefined> {
    ...
    return {
        ...
        sparkBalance: {availableBalance: 1, fullBalance: 1, unconfirmedBalance: 1},
    };
}
