...
import animicaNetworks from './networks';
import { NetworkNames } from '@enkryptcom/types';

export default class AnimicaProvider
  ...
  implements BackgroundProviderInterface
{
  ...
  constructor(
    toWindow: (message: string) => void,
    network: BaseNetwork = animicaNetworks[NetworkNames.Animica],
  ) {
    super();
    ...
    this.namespace = ProviderName.animica;
