...
import { MVXToken } from '@/providers/multiversx/types/mvx-token';
...
const network = ref<BaseNetwork>(DEFAULT_MULTIVERSX_NETWORK);
...
const sendAction = async () => {
  ...
  try {
    ...
    const networkApi = (await network.value.api()) as MultiversXApi;
    const txHash = await networkApi.sendTransaction(transaction);
