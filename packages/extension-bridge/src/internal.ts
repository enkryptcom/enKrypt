...
const handleInboundMessage = async (message: IInternalMessage): Promise<void> => {
...
export const routeMessage = (message: IInternalMessage): void | Promise<void> => {
...
const assertInternalMessage: (x: unknown) => asserts x = (_msg: any): asserts _msg is IInternalMessage => {
  // todo
}
